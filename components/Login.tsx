      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row h-[600px]">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="text-center md:text-left mb-8">
            ...
            <p className="text-slate-500 text-sm mt-1">Ingresa tus credenciales administrativas</p>
          </div>

          {error && (
            <div className="mb-4 p-3 rounded-lg bg-red-50 text-red-600 text-sm flex items-center gap-2 border border-red-100 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-slate-400">Si olvidaste tu contraseña, contacta al soporte técnico.</p>
          </div>
        </div>
      </div>
      <PublicAgent />
